...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697586205
...
cp %{_builddir}/libsmbios-%{version}/COPYING %{buildroot}/usr/share/package-licenses/libsmbios/4afbd7e5ca260d6c64092024bac05696502dc793 || :
cp %{_builddir}/libsmbios-%{version}/COPYING-GPL %{buildroot}/usr/share/package-licenses/libsmbios/4afbd7e5ca260d6c64092024bac05696502dc793 || :
cp %{_builddir}/libsmbios-%{version}/COPYING-OSL %{buildroot}/usr/share/package-licenses/libsmbios/3f1315be456c9c668553327b4a3dec6b2c0c78ee || :
cp %{_builddir}/libsmbios-%{version}/doc/getopt/LICENSE %{buildroot}/usr/share/package-licenses/libsmbios/015f46d67e4031de55a746be5cbfdd9b648fe3ad || :
cp %{_builddir}/libsmbios-%{version}/pkg/debian/copyright %{buildroot}/usr/share/package-licenses/libsmbios/91ae711b5bb5119d16aa4a696a0c0d28b5c23373 || :
cp %{_builddir}/libsmbios-%{version}/src/bin/getopts_LICENSE.txt %{buildroot}/usr/share/package-licenses/libsmbios/8c56891520694dd69dbf83c05e79b40a7505965b || :
%make_install
%find_lang libsmbios
